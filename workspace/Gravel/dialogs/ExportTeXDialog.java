...
public class ExportTeXDialog extends JDialog implements ActionListener, CaretListener
{
	...
	private ButtonGroup DocumentChoice;
	private JRadioButton rWholeDocument, rOnlyFigure;
	...
	public ExportTeXDialog(Frame parent, int ox, int oy)
	{
		...
		c.gridx = 0;
		c.gridwidth=3;
		content.add(new JLabel("<html><b>Achtung</b> : Im TeX-Export werden Farben ignoriert.<br>Schriftgr"+main.CONST.html_oe+main.CONST.html_sz+"en k"+main.CONST.html_oe+"nnen leicht varriieren, da TeX einen anderen Font verwendet.</html>"),c);
		c.gridy++;
		c.gridx = 1;
